...
c_default_bpool_tweaks="-o ashift=12 -O compression=off -o compatibility=grub2"
c_default_rpool_tweaks="-o ashift=12 -O acltype=posixacl -o compatibility=ubuntu-22.04 -O compression=zstd-9 -O dnodesize=auto -O relatime=on -O xattr=sa -O normalization=formD"
