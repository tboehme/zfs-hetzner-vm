...
c_default_bpool_tweaks="-o ashift=12 -O compression=off -o compatibility=grub2,openzfs-2.1-linux"
c_default_rpool_tweaks="-o ashift=12 -O acltype=posixacl -o compatibility=openzfs-2.1-linux -O compression=zstd-9 -O dnodesize=auto -O relatime=on -O xattr=sa -O normalization=formD"
